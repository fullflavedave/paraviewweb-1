...
function _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } } /* global window EventSource document */
...
function build() {
  var config = arguments.length <= 0 || arguments[0] === undefined ? window.location : arguments[0];
