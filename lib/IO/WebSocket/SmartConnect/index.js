...
function autobahnConnect(self) {
  ...
  console.log('Before autoBahnConnect(), wsConnection.connect()');
  wsConnection.connect();
  console.log('After autoBahnConnect(), wsConnection.connect()');
...
var SmartConnect = function () {
  function SmartConnect(config) {
    console.log('SmartConnect(), config = ', config);
    var _this = this;
  ...
  _createClass(SmartConnect, [{
    ...
    value: function connect() {
      console.log('starting SmartConnect.connect()');
      var _this2 = this;

      if (this.config.sessionURL) {
        // We have a direct connection URL
        console.log('calling autobahnConnect() = ');
        autobahnConnect(this);
      } else {
        console.log('using the Launcher');
