...
(0, _tapeCatch2.default)('DataManager - Download Binary Data', function (t) {
  var dataManager = new _2.default();
  var dataTypes = Object.keys(dataTesting);
  ...
  function processData(name) {
    dataManager.on('/base/data/binary/' + name, function (d, envelope) {
      ...
      var nativeToArray = [];
      var valideValues = dataTesting[name].values;

      var count = nativeArray.length;
      var dataIsEquals = true;
    ...
    var url = dataManager.fetchURL(fetchURL, 'arraybuffer');
...
(0, _tapeCatch2.default)('DataManager - Trigger n fetch and check the amount of notification', function (t) {
  var dataManager = new _2.default();
  var urlToFetch = '/base/data/dummy/0_1.png';
  var numberToTry = 10;
  var fetchCount = 0;
...
(0, _tapeCatch2.default)('Data Manager - Download JSON/Images using pattern', function (t) {
  var urlToBeValid = [];
  var dataManager = new _2.default();
  var nbImageAvailable = 0;
  var exepectedNbImages = 1;
  var nbToFree = 0;
  var alreadyFree = 0;
  ...
  dataManager.on('images', function (d, envelope) {
    nbImageAvailable++;
  ...
  var url = dataManager.fetchURL(fetchURL, 'json');
