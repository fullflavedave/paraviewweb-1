define(['exports', 'mout/src/object/equals', 'react', 'PVWStyle/ReactViewers/LineChartViewer.mcss', '../../../Common/Misc/SizeHelper'], function (exports, _equals, _react, _LineChartViewer, _SizeHelper) {
  'use strict';
  ...
  exports.default = _react2.default.createClass({
    ...
    drawChart: function drawChart() {
      ...
      if (this.state.legend) {
        this.xValueLabel.innerHTML = ((this.props.data.xRange[1] - this.props.data.xRange[0]) * ratio + this.props.data.xRange[0]).toFixed(5);
    ...
    render: function render() {
      ...
      Object.keys(this.state.fieldsColors).forEach(function (name) {
        ...
        legend.push(_react2.default.createElement(
          ...
          _react2.default.createElement('span', { className: _LineChartViewer2.default.legendItemValue, ref: function ref(c) {
              _this[name] = c;
            } })
        ));
      });
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            ...
            _react2.default.createElement('span', { className: _LineChartViewer2.default.legendText, ref: function ref(c) {
                _this.xValueLabel = c;
              } }),
