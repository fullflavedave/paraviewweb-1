define(['exports', 'react', 'PVWStyle/ReactCollapsibleControls/VolumeControl.mcss', '../../Widgets/CollapsibleWidget', '../../Widgets/EqualizerWidget', '../../Widgets/ToggleIconButtonWidget', '../../Widgets/LookupTableWidget'], function (exports, _react, _VolumeControl, _CollapsibleWidget, _EqualizerWidget, _ToggleIconButtonWidget, _LookupTableWidget) {
  'use strict';
  ...
  exports.default = _react2.default.createClass({
    ...
    render: function render() {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          _CollapsibleWidget2.default,
          { title: 'Opacity Control', subtitle: [cpuGpuButton, resetOpacityButton], activeSubTitle: true },
