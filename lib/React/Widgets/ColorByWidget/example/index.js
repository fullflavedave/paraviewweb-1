...
var _sourceProxy = require('../../ProxyEditorWidget/example/source-proxy.json');

var _sourceProxy2 = _interopRequireDefault(_sourceProxy);

var _representationProxy = require('../../ProxyEditorWidget/example/representation-proxy.json');
