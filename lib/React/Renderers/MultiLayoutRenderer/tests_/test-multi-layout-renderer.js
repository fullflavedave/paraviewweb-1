define(['react', 'react-dom', '..', '../../../../IO/Core/QueryDataModel', '../../../../Rendering/Image/DataProberImageBuilder', '../../../../Common/Core/LookupTableManager', 'mout/src/array/equals', 'expect', 'react/lib/ReactTestUtils', 'tonic-arctic-sample-data/data/probe/index.json'], function (_react, _reactDom, _, _QueryDataModel, _DataProberImageBuilder, _LookupTableManager, _equals, _expect, _ReactTestUtils, _index) {
    'use strict';
