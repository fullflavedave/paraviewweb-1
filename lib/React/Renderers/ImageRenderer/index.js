define(['exports', 'react', 'monologue.js', 'PVWStyle/ReactRenderers/ImageRenderer.mcss', '../../Widgets/ContentEditableWidget', '../../../Common/Misc/ImageExporter', '../../../Common/Misc/SizeHelper', '../../../Interaction/Core/MouseHandler'], function (exports, _react, _monologue, _ImageRenderer, _ContentEditableWidget, _ImageExporter, _SizeHelper, _MouseHandler) {
  'use strict';
  ...
  var DRAW_DONE = 'ImageRenderer.draw.done'; /* global Image document */
  ...
  var ImageRenderer = _react2.default.createClass({
    ...
    componentDidMount: function componentDidMount() {
      ...
      this.mouseHandler.on('modifier.change', function (change, envelope) {
        var image = _this2.imageToDraw,
            ctx = _this2.canvasRenderer.getContext('2d');
    ...
    handleKeyDown: function handleKeyDown(event) {
      if (event.keyCode === 82) {
        ...
        var thumbnailImage = this.thumbnail;
    ...
    render: function render() {
      ...
      return _react2.default.createElement(
        'div',
        { className: _ImageRenderer2.default.container, ref: function ref(c) {
            _this3.rootContainer = c;
          } },
        _react2.default.createElement('canvas', {
          className: _ImageRenderer2.default.renderer,
          ref: function ref(c) {
            _this3.canvasRenderer = c;
          },
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            ...
            _react2.default.createElement('img', {
              ...
              className: _ImageRenderer2.default.thumbnail,
