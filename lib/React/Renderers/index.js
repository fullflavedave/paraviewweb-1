define(['exports', './GeometryRenderer', './ImageRenderer', './MultiLayoutRenderer', './PlotlyRenderer', './VtkRenderer'], function (exports, _GeometryRenderer, _ImageRenderer, _MultiLayoutRenderer, _PlotlyRenderer, _VtkRenderer) {
  'use strict';
