define(['exports', 'mout/src/array/contains', 'mout/src/object/equals', '../AbstractImageBuilder', '../../../Common/Misc/CanvasOffscreenBuffer'], function (exports, _contains, _equals, _AbstractImageBuilder2, _CanvasOffscreenBuffer) {
  'use strict';
            ...
            for (var i = 0; i < size; i++) {
              ...
              if (color[3]) {
                ...
                if (layer.hasMesh && layer.meshActive && layer.mesh && layer.mesh[flipedY]) {
                  pixels[i * 4 + 0] = _this3.meshColor[0];
