define(['exports', 'three'], function (exports, _three) {
	...
	_three2.default.TrackballControls = function (object, domElement) {
		...
		this.resetCamera = function (center, radius) {
			...
			var direction = new _three2.default.Vector3().subVectors(_this.object.position, _this.target).normalize().multiplyScalar(2.7 * radius);
	...
	exports.default = _three2.default.TrackballControls;
});